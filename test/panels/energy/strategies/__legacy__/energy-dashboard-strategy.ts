...
import type { LovelaceStrategyConfig } from "../../../../../src/data/lovelace/config/strategy";
import type { LovelaceConfig } from "../../../../../src/data/lovelace/config/types";
import type { LovelaceStrategyViewConfig } from "../../../../../src/data/lovelace/config/view";
import type { LocalizeKeys } from "../../../../../src/common/translations/localize";
...
export class LegacyEnergyDashboardStrategy {
  ...
  static async generate(
    ...
    if (
      ...
      await import("../../../../../src/panels/energy/cards/energy-setup-wizard-card");
      return {
        views: [WIZARD_VIEW],
      };
    }
